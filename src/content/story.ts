...
export const BEATS: Beat[] = [
  ...
  },
  {
    ...
    run: (c, s) => {
      ...
      window.setTimeout(() => c.hud.say([DIALOGUE.devonAfterMatch[0]], 3.0), 2600);
      window.setTimeout(() => c.hud.say([DIALOGUE.devonAfterMatch[1]], 3.4), 6000);
      window.setTimeout(() => c.hud.say([DIALOGUE.devonAfterMatch[2]], 3.6), 9800);
    },
  },
  {
    id: 'the-crack',
  ...
  },
  {
    ...
    run: (c, s) => {
      ...
      window.setTimeout(() => c.hud.say([DIALOGUE.devonStopped[1]], 3.4), 4200);
      window.setTimeout(() => c.hud.say([DIALOGUE.playerThought[0]], 3.4), 9000);
      s.devonReleasedAt = c.sim.tick + 60 * 45;
      // The player can now hold VISION, because they have started to see it.
      c.sim.unlockVision();
      c.audio.motif(0.6);
      window.setTimeout(() => {
        c.sim.message('SYSTEM', ['SAFEtrace VISION — AVAILABLE', 'HOLD Q'], 6.0);
      }, 12000);
    },
  },
  ...
  },
  {
    ...
    run: (c, s) => {
      ...
      window.setTimeout(() => {
        c.sim.message('SYSTEM', ['QUERY AND TRACE AVAILABLE', 'PRESS E'], 6.0);
      }, 4000);
    },
  },
  {
    ...
    run: (c, s) => {
      ...
      window.setTimeout(() => c.sim.message('SYSTEM', [
      ...
      window.setTimeout(() => c.hud.say([DIALOGUE.playerThought[1]], 4.5), 15000);
    },
  },
  {
    id: 'reprise',
